            ...
            <div className="md:grid md:grid-cols-12 md:gap-6 items-center">
              ...
              <div className="max-w-xl md:max-w-none md:w-full mx-auto md:col-span-7 lg:col-span-6" data-aos="fade-left">
                <div className="md:pl-4 lg:pl-12 xl:pl-16">
                  ...
                  <h3 className="h3 mb-3">Holy Word</h3>
                  ...
                  <div className="mt-4">
                    <a href="https://gitlab.com/appcoholic1/BibleMultiTheLight/-/archive/master/BibleMultiTheLight-master.zip" className="text-purple-600 hover:underline">Download Source</a>
                  </div>
                </div>
              </div>
            </div>
